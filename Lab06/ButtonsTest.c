...
int main(void)
{
    ...
    while(1){
        if (bottomEvent != BUTTON_EVENT_NONE){
            if (bottomEvent & BUTTON_EVENT_1UP) {
                printf("BUTTON_EVENT_1UP"); 
            } 
            if (bottomEvent & BUTTON_EVENT_1DOWN) {
                printf("BUTTON_EVENT_1DOWN");
            } 
            if (bottomEvent & BUTTON_EVENT_2UP) {
                printf("BUTTON_EVENT_2UP"); 
            } 
            if (bottomEvent & BUTTON_EVENT_2DOWN) {
                printf("BUTTON_EVENT_2DOWN");
            } 
            if (bottomEvent & BUTTON_EVENT_3UP) {
                printf("BUTTON_EVENT_3UP"); 
            } 
            if (bottomEvent & BUTTON_EVENT_3DOWN) {
                printf("BUTTON_EVENT_3DOWN");
            } 
            if (bottomEvent & BUTTON_EVENT_4UP) {
                printf("BUTTON_EVENT_4UP"); 
            } 
            if (bottomEvent & BUTTON_EVENT_4DOWN) {
