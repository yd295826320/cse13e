...
int main()
{
    ...
    // Add more tests here!
    //MatrixEquals
    if (MatrixEquals(mat_1, mat_2) && !(MatrixEquals(mat_1, mat_3))){            //another test
        ind += 1;
    ...
    //trace
    x = MatrixTrace(mat_4);                                                     //trace werid output                                      
    if (x == 3){
        ind += 0.5;
        p += 1;
    }
    ...
    //det
    x = MatrixDeterminant(mat_1);                                               //det not working                         
    if (x == 0){
        ind += 0.5;
        p += 1;;
    }
    ...
    //inverse
    MatrixPrint(zero_mat3);                                                   //inverse not working
    MatrixInverse(mat_7,zero_mat3);
    MatrixPrint(zero_mat3);
